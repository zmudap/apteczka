            ...
            if(isset($_POST['apteczka']) || isset($_SESSION['po_usuwaniu']))    
            {
                ...
                else
                {
                    ...
                    {  
                        ...
                        {
                            $rezultaty = $polaczenie->query("SELECT ListaLekow.NazwaHandlowa, leki_w_apteczkach.koszt, leki_w_apteczkach.data_waznosci, leki_w_apteczkach.id_leku FROM ListaLekow, leki_w_apteczkach, apteczki WHERE ListaLekow.id=leki_w_apteczkach.id_leku AND leki_w_apteczkach.id_apteczki=$id_apteczki");
